    ...
    borrowCon.borrow(con =>
      Try {
        queryParams.flatMap(param => {
          val crRs = con.getMetaData.getCrossReference(param._1.orNull,
                                                       param._2.orNull,
                                                       param._3.orNull,
                                                       param._1.orNull,
                                                       param._2.orNull,
